...
; This file was generated Fri Apr 24 23:12:43 2015
;--------------------------------------------------------
	.module hal_board
...
;------------------------------------------------------------
	G$halBoardInit$0$0 ==.
	C$hal_board.c$33$0$0 ==.
;	hal_board.c:33: void halBoardInit( void ) {
;	-----------------------------------------
...
_halBoardInit:
	...
	ar1 = 0x01
	ar0 = 0x00
	C$hal_board.c$35$1$12 ==.
;	hal_board.c:35: halMcuInit( );
	lcall	_halMcuInit
	C$hal_board.c$39$1$12 ==.
	XG$halBoardInit$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)

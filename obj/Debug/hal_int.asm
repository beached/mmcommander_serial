...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'halIntOn'
;------------------------------------------------------------
	G$halIntOn$0$0 ==.
	C$hal_int.c$30$0$0 ==.
;	hal_int.c:30: void halIntOn( void ) {
;	-----------------------------------------
;	 function halIntOn
;	-----------------------------------------
_halIntOn:
	...
	ar0 = 0x00
	C$hal_int.c$31$2$11 ==.
;	hal_int.c:31: HAL_INT_ON( );
	setb	_EA
	C$hal_int.c$32$1$10 ==.
	XG$halIntOn$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'halIntOff'
;------------------------------------------------------------
	G$halIntOff$0$0 ==.
	C$hal_int.c$44$1$10 ==.
;	hal_int.c:44: void halIntOff( void ) {
;	-----------------------------------------
;	 function halIntOff
;	-----------------------------------------
_halIntOff:
	C$hal_int.c$45$2$14 ==.
;	hal_int.c:45: HAL_INT_OFF( );
	clr	_EA
	C$hal_int.c$46$1$13 ==.
	XG$halIntOff$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$halIntLock$0$0 ==.
	C$hal_int.c$59$1$13 ==.
;	hal_int.c:59: uint16_t halIntLock( void ) {
;	-----------------------------------------
;	 function halIntLock
;	-----------------------------------------
_halIntLock:
	C$hal_int.c$61$2$17 ==.
;	hal_int.c:61: HAL_INT_LOCK( key );
	mov	c,_EA
	clr	a
	rlc	a
	mov	r6,a
...
;------------------------------------------------------------
	G$halIntUnlock$0$0 ==.
	C$hal_int.c$76$1$16 ==.
;	hal_int.c:76: void halIntUnlock( uint16_t key ) {
;	-----------------------------------------

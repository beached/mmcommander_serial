...
;------------------------------------------------------------
	...
	C$clock.c$34$0$0 ==.
;	clock.c:34: void clockSetMainSrc( uint8_t source ) {
;	-----------------------------------------
;	 function clockSetMainSrc
;	-----------------------------------------
_clockSetMainSrc:
	ar7 = 0x07
	ar6 = 0x06
...
;	clock.c:41: SLEEP &= ~SLEEP_OSC_PD_BM;          // power up both oscillators
	...
	mov	_SLEEP,a
	C$clock.c$42$2$6 ==.
;	clock.c:42: CLKCON |= CLKCON_OSC_BM;            // change system clock source to HS RCOSC
	orl	_CLKCON,#0x40
	C$clock.c$43$2$6 ==.
;	clock.c:43: while( !(CLKCON & CLKCON_OSC_BM) );  // wait until CLKCON.OSC = 1
00101$:
	mov	a,_CLKCON
	jnb	acc.6,00101$
	C$clock.c$46$2$6 ==.
...
00104$:
	mov	a,r5
	cjne	a,_CLKCON,00104$
	C$clock.c$49$2$6 ==.
;	clock.c:49: SLEEP |= SLEEP_OSC_PD_BM;           // power down the unused oscillator
	orl	_SLEEP,#0x04
	sjmp	00118$
00116$:
	C$clock.c$50$1$5 ==.

...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'halMcuInit'
;------------------------------------------------------------
	G$halMcuInit$0$0 ==.
	C$hal_mcu.c$23$0$0 ==.
;	hal_mcu.c:23: void halMcuInit( void ) {
;	-----------------------------------------
;	 function halMcuInit
;	-----------------------------------------
_halMcuInit:
	...
	ar0 = 0x00
	C$hal_mcu.c$24$1$11 ==.
;	hal_mcu.c:24: clockSetMainSrc( CLOCK_SRC_XOSC );
	mov	dpl,#0x00
	lcall	_clockSetMainSrc
	C$hal_mcu.c$25$1$11 ==.
	XG$halMcuInit$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$halMcuWaitUs$0$0 ==.
	C$hal_mcu.c$46$1$11 ==.
;	hal_mcu.c:46: void halMcuWaitUs( uint16_t usec ) {
;	-----------------------------------------
...
;------------------------------------------------------------
	G$halMcuWaitMs$0$0 ==.
	C$hal_mcu.c$84$1$13 ==.
;	hal_mcu.c:84: void halMcuWaitMs( uint16_t msec ) {
;	-----------------------------------------
...
;	hal_mcu.c:104: void halMcuSetLowPowerMode( uint8_t mode ) {
;	-----------------------------------------

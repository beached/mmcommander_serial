 ...
 *                                        - ioCC1110.h -
 *
 * Special header for the Texas Instruments CC1110 System on Chip.
 *
 **************************************************************************************************
 */
 ...
 * ------------------------------------------------------------------------------------------------
 */
#define  RFTXRX_VECTOR  VECT(  0, 0x03 )   /*  RF TX done / RX ready                       */
...
#define  T2_VECTOR      VECT( 10, 0x53 )   /*  Timer 2 (MAC Timer) Overflow                */
 ...
 * ------------------------------------------------------------------------------------------------
 */
#define  I2SRX_VECTOR   URX1_VECTOR        /*  I2S RX Complete, alias for URX1_VECTOR      */
#define  I2STX_VECTOR   UTX1_VECTOR        /*  I2S TX Complete, alias for UTX1_VECTOR      */
...
SFRBIT( TCON    ,  0x88, URX1IF, _TCON6, ADCIF, _TCON4, URX0IF, _TCON2, RFTXRXIF, _TCON0 )
...
/* U1CSR */
SBIT(  U1MODE    ,  0xFF  )  /*  USART 1 Mode Select                         */
SBIT(  U1RE      ,  0xFE  )  /*  UART 1 Receiver Enable                      */
SBIT(  U1SLAVE   ,  0xFD  )  /*  SPI 1 Master or Slave Mode Select           */
SBIT(  U1FE      ,  0xFC  )  /*  UART 1 Framing Error Status                 */
SBIT(  U1ERR     ,  0xFB  )  /*  UART 1 Parity Error Status                  */
SBIT(  U1RX_BYTE ,  0xFA  )  /*  Receive Byte Status                         */
SBIT(  U1TX_BYTE ,  0xF9  )  /*  Transmit Byte Status                        */
SBIT(  U1ACTIVE  ,  0xF8  )  /*  USART 1 Transmit/Receive Active Status      */
...
/* SFR bits */
#define  I2SRXIE   URX1IE    /*  I2S RX interrupt enable                     */
/*       I2STXIE             ,   not in a bit addressable register           */
#define  I2SRXIF   URX1IF    /*  I2S RX interrupt flag                       */
#define  I2STXIF   UTX1IF    /*  I2S TX interrupt flag                       */

/* SFRs */
#define  WORCTL    WORCTRL   /*  For backward compatibility after name change*/
...
#define  FSTEST      XREG( 0xDF20 )  /*  Frequency synthesizer calibration control           */
#define  PTEST       XREG( 0xDF21 )  /*  Production test                                     */
#define  AGCTEST     XREG( 0xDF22 )  /*  AGC test                                            */
...
#define  PA_TABLE7   XREG( 0xDF27 )  /*  PA power setting 7                                  */
#define  PA_TABLE6   XREG( 0xDF28 )  /*  PA power setting 6                                  */
#define  PA_TABLE5   XREG( 0xDF29 )  /*  PA power setting 5                                  */
#define  PA_TABLE4   XREG( 0xDF2A )  /*  PA power setting 4                                  */
#define  PA_TABLE3   XREG( 0xDF2B )  /*  PA power setting 3                                  */
#define  PA_TABLE2   XREG( 0xDF2C )  /*  PA power setting 2                                  */
#define  PA_TABLE1   XREG( 0xDF2D )  /*  PA power setting 1                                  */
#define  PA_TABLE0   XREG( 0xDF2E )  /*  PA power setting 0                                  */
#define  IOCFG2      XREG( 0xDF2F )  /*  Radio Test Signal Configuration (P1_7)              */
#define  IOCFG1      XREG( 0xDF30 )  /*  Radio Test Signal Configuration (P1_6)              */
#define  IOCFG0      XREG( 0xDF31 )  /*  Radio Test Signal Configuration (P1_5)              */
...
#define  PARTNUM     XREG( 0xDF36 )  /*  Chip ID [15:8]                                      */
#define  VERSION     XREG( 0xDF37 )  /*  Chip ID [7:0]                                       */
 ...
 * ------------------------------------------------------------------------------------------------
 */
#define  I2SCFG0     XREG( 0xDF40 )  /*  I2S Configuration Register 0                        */
#define  I2SCFG1     XREG( 0xDF41 )  /*  I2S Configuration Register 1                        */
#define  I2SDATL     XREG( 0xDF42 )  /*  I2S Data Low Byte                                   */
#define  I2SDATH     XREG( 0xDF43 )  /*  I2S Data High Byte                                  */
#define  I2SWCNT     XREG( 0xDF44 )  /*  I2S Word Count Register                             */
#define  I2SSTAT     XREG( 0xDF45 )  /*  I2S Status Register                                 */
#define  I2SCLKF0    XREG( 0xDF46 )  /*  I2S Clock Configuration Register 0                  */
#define  I2SCLKF1    XREG( 0xDF47 )  /*  I2S Clock Configuration Register 1                  */
#define  I2SCLKF2    XREG( 0xDF48 )  /*  I2S Clock Configuration Register 2                  */

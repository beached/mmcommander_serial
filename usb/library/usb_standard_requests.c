...
static void ConfigureEndpoints( USB_INTERFACE_DESCRIPTOR __code *pInterface ) {
	uint8_t n = 0;
	uint16_t maxpRegValue = 0;
	uint8_t csRegValue = 0;
	uint8_t endpoint = 0;
	USB_ENDPOINT_DESCRIPTOR __code *pEndpoint = NULL;
	DBLBUF_LUT_INFO __code *pUsbDblbufLutInfo = NULL;
...
void usbsrSetConfiguration( void ) {
	uint8_t n = 0;
	USB_CONFIGURATION_DESCRIPTOR __code *pConfiguration = NULL;
	USB_INTERFACE_DESCRIPTOR __code *pInterface = NULL;

...
/// \name Module Data
//@{
EXTERN USBFW_DATA  usbfwData; ///< USBFW internal module data
...
//@{
EXTERN USB_SETUP_DATA  usbSetupData; ///< Setup handler data phase configuration
EXTERN USB_SETUP_HEADER  usbSetupHeader; ///< Setup header
//@}
//-------------------------------------------------------------------------------------------------------
